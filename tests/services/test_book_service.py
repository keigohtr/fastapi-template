...
def test_create_book_happycase(book_service: BookService, function_db: Session):
    title = "title"
...
def test_list_books_happycase(book_service: BookService, function_db: Session):
...
def test_list_books_invalid(book_service: BookService, function_db: Session):
    create_random_book(function_db, title="book1")
    create_random_book(function_db, title="book2")
...
def test_fetch_book_happycase(book_service: BookService, function_db: Session):
